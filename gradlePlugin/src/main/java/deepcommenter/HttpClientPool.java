...
public class HttpClientPool {
    ...
    public String storeFeedbackPost(String url, HashMap<String, String> requestParams) throws Exception {
        HttpPost httpPost = new HttpPost(url);
        List<NameValuePair> nvps = new ArrayList<>();
    ...
    private String getResponseContent(String url, HttpRequestBase request) throws Exception {
        ...
        try {
            response = this.getHttpClient(1000,1000).execute(request);
